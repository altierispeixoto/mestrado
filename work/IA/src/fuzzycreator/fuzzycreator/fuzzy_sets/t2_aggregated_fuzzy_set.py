...
class T2AggregatedFuzzySet():
    ...
    def add_membership_function(self, mf):
        ...
        self.zlevel_coords = [((Decimal(i)/self._total_membership_functions)
    ...
    def calculate_secondary_membership(self, x, y):
        ...
        for mf in self.membership_functions:
            if y <= mf.calculate_membership(x):
                mfs_within += 1
        return ((Decimal(mfs_within) / self._total_membership_functions)
                .quantize(gs.DECIMAL_ROUNDING))
    ...
    def calculate_centroid(self):
        ...
        for z in self.zlevel_coords:
            ...
            result_bottom += z
        return (result_top / result_bottom).quantize(gs.DECIMAL_ROUNDING)
