...
class Type1IAATest(unittest.TestCase):
    ...
    def test_membership_normal_convex(self):
        ...
        fs1 = FuzzySet(mf1)
        self.assertEquals(fs1.calculate_membership(0.6), 1)
        self.assertEquals(fs1.calculate_membership(0.48), Decimal('0.5'))
    ...
    def test_alpha_cut_convex(self):
        ...
        # are non-convex.
        self.assertEquals(fs1.calculate_alpha_cut(Decimal('0.25')),
                          [(Decimal('0.42'), Decimal('0.84'))])
        self.assertEquals(fs1.calculate_alpha_cut(Decimal('0.5')),
                          [(Decimal('0.42'), Decimal('0.84'))])
        self.assertEquals(fs1.calculate_alpha_cut(Decimal('0.75')),
                          [(Decimal('0.51'), Decimal('0.77'))])
        self.assertEquals(fs1.calculate_alpha_cut(Decimal('1')),
                          [(Decimal('0.51'), Decimal('0.77'))])
    ...
    def test_alpha_cut_non_convex(self):
        ...
        self.assertEquals(fs1.calculate_alpha_cut(Decimal('1.0')),
    ...
    def test_membership_normality(self):
        ...
        mf1.add_interval((Decimal('0.7'), Decimal('0.9')))
        fs1 = FuzzySet(mf1)
        self.assertEquals(fs1.calculate_membership(Decimal('0.15')), 0)
        self.assertEquals(fs1.calculate_membership(Decimal('0.25')),
                          Decimal('0.5'))
        self.assertEquals(fs1.calculate_membership(Decimal('0.35')), 1)
        self.assertEquals(fs1.calculate_membership(Decimal('0.6')),
                          Decimal('0.5'))
        self.assertEquals(fs1.calculate_membership(Decimal('0.7')), 1)
        self.assertEquals(fs1.calculate_membership(Decimal('0.85')),
                          Decimal('0.5'))
        self.assertEquals(fs1.calculate_membership(Decimal('0.95')), 0)
        mf1.normalise = False
        self.assertEquals(fs1.calculate_membership(Decimal('0.15')), 0)
        self.assertEquals(fs1.calculate_membership(Decimal('0.25')),
                          Decimal('0.3333'))
        self.assertEquals(fs1.calculate_membership(Decimal('0.35')),
                          Decimal('0.6667'))
        self.assertEquals(fs1.calculate_membership(Decimal('0.6')),
                          Decimal('0.3333'))
        self.assertEquals(fs1.calculate_membership(Decimal('0.7')),
                          Decimal('0.6667'))
        self.assertEquals(fs1.calculate_membership(Decimal('0.85')),
                          Decimal('0.3333'))
        self.assertEquals(fs1.calculate_membership(Decimal('0.95')), 0)
    ...
    def test_centroid(self):
        ...
        fs1 = FuzzySet(mf1)
        self.assertEquals(fs1.calculate_centroid(), Decimal('0.5'))
        fs1.normalise = False
        self.assertEquals(fs1.calculate_centroid(), Decimal('0.5'))
        mf1 = IntervalAgreementApproach(normalise=True)
        mf1.add_interval((Decimal('0.2'), Decimal('0.8')))
