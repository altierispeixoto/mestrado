...
class DiscreteT2Test(unittest.TestCase):
    ...
    def test_fuzzy_set(self):
        ...
        self.assertEquals(fsA.calculate_membership(1, 0.7),
                          (Decimal('0.8000'), Decimal('0.9000')))
        self.assertEquals(fsA.calculate_secondary_membership(1,
                                                             Decimal('0.8')),
                          Decimal('0.9'))
        ...
        self.assertEquals(fsA.calculate_alpha_cut_upper(0.6), (1, 3))
        self.assertEquals(fsA.calculate_alpha_cut_upper(0.7), (1, 2))
        self.assertEquals(fsA.calculate_alpha_cut_upper(0.8), (1, 1))
