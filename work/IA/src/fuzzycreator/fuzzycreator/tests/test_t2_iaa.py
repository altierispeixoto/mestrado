...
class Type2IAATest(unittest.TestCase):
    ...
    def test_fuzzy_set(self):
        """Test alpha-cuts."""
        self.assertEquals(self.t2_fs.calculate_alpha_cut_upper(
    ...
    def test_zlevel_validation(self):
        ...
        self.assertEquals(self.t2_fs.validate_zlevel(Decimal('0.25')),
                          Decimal('0.3333'))
        self.assertEquals(self.t2_fs.validate_zlevel(Decimal('0.3333')),
                          Decimal('0.3333'))
        self.assertEquals(self.t2_fs.validate_zlevel(Decimal('0.5')),
                          Decimal('0.6667'))
        self.assertEquals(self.t2_fs.validate_zlevel(Decimal('0.6667')),
                          Decimal('0.6667'))
        self.assertEquals(self.t2_fs.validate_zlevel(Decimal('0.75')),
                          Decimal('1'))
        self.assertEquals(self.t2_fs.validate_zlevel(Decimal('1')),
                          Decimal('1'))

    def test_it2_membership(self):
        """Test calculating membership for IT2 FS."""
        self.assertEquals(self.t2_fs.calculate_membership(Decimal('0.18')),
                          (Decimal(0), Decimal('0.5')))
        self.assertEquals(self.t2_fs.calculate_membership(Decimal('0.32')),
                          (Decimal(0), Decimal('1')))
        self.assertEquals(self.t2_fs.calculate_membership(Decimal('0.5')),
                          (Decimal(0), Decimal('1')))
        self.assertEquals(self.t2_fs.calculate_membership(Decimal('0.9')),
                          (Decimal(0), Decimal('0.5')))
    ...
    def test_gt2_membership(self):
        ...
        self.assertEquals(self.t2_fs.calculate_membership(Decimal('0.5'),
                                                          Decimal('0.6667')),
                          (Decimal(0), Decimal('0.5')))
        self.assertEquals(self.t2_fs.calculate_membership(Decimal('0.52'),
                                                          Decimal('0.6667')),
                          (Decimal(0), Decimal('1')))
        self.assertEquals(self.t2_fs.calculate_membership(Decimal('0.18'),
                                                          Decimal('1')),
        ...
        self.assertEquals(self.t2_fs.calculate_membership(Decimal('0.52'),
                                                          Decimal('1')),
                          (Decimal(0), Decimal('0.5')))
        self.assertEquals(self.t2_fs.calculate_membership(Decimal('0.65'),
                                                          Decimal('1')),
                          (Decimal(0), Decimal(1)))
